...
export class MovieDetailsComponent implements OnInit {
  ...
  constructor(private service:MovieApiServiceService,private router:ActivatedRoute,private title:Title,private meta:Meta, public auth: AuthService, public route: Router) { }
